...
pages = [
    ...
    pathlib.Path("install/apio.md"),
    pathlib.Path("install/version-1-0.md"),
    pathlib.Path("install/version-1-1.md"),
    pathlib.Path("install/version-1-2.md"),
    pathlib.Path("install/migrate-to-1-1.md"),
    pathlib.Path("install/migrate-to-1-2.md"),
    pathlib.Path("install/versions.md"),
