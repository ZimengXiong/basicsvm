...
pages = [
    ...
    pathlib.Path("use/results.md"),
    pathlib.Path("getting-started.md"),
    ...
    pathlib.Path("help/install.md"),
    pathlib.Path("help/networking.md"),
    pathlib.Path("help/openlane.md"),
    pathlib.Path("using/examples-templates-work.md"),
