...
1. Download [bASICs VM for Linux ARM](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/72f7930/linux-arm/basicsvm-aarch64-linux.qcow2?download=true).
