...
2. Download [bASICs VM for Windows x86](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/1.4/windows-x86/basicsvm-x86_64-linux.ova).
3. Open VirtualBox.
