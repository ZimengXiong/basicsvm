...
2. Download [bASICs VM for Windows x86](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/a8e15c5/windows-x86/basicsvm-x86_64-linux.ova?download=true).
3. Open VirtualBox.
