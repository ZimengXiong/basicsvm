...
2. Download [bASICs VM for Windows x86](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/ae2a0cd/windows-x86/basicsvm-x86_64-linux.ova?download=true).
3. Open VirtualBox.
