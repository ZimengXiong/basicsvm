...
2. Download [bASICs VM for Intel Mac](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/1.2/macos-intel/bASICs-VM-Intel-Mac.utm.zip?download=true).
