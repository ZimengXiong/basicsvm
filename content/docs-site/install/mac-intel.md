...
Use this page for Macs with an Intel processor.
...
2. Download [bASICs VM for Intel Mac](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/e47a9b6-vscodium-go-board/macos-intel/bASICs-VM-Intel-Mac.utm.zip?download=true).
