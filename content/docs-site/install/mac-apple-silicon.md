...
2. Download [bASICs VM for Apple Silicon](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/ae2a0cd/macos-apple-silicon/bASICs-VM-Apple-Silicon.utm.zip?download=true).
