...
2. Download [bASICs VM for Apple Silicon](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/1.2/macos-apple-silicon/bASICs-VM-Apple-Silicon.utm.zip?download=true).
