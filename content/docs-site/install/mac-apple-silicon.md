...
2. Download [bASICs VM for Apple Silicon](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/e47a9b6-vscodium-go-board/macos-apple-silicon/bASICs-VM-Apple-Silicon.utm.zip?download=true).
