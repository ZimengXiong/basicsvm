...
2. Download [bASICs VM for Windows ARM](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/c986d89/windows-arm/bASICs-VM-Windows-ARM.ova?download=true).
3. Open VirtualBox.
