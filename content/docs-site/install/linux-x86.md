...
2. Download [bASICs VM for Linux x86](https://huggingface.co/datasets/zimengxiong/basicsvm/resolve/main/releases/1.2/linux-x86/basicsvm-x86_64-linux.ova?download=true).
3. Open VirtualBox.
